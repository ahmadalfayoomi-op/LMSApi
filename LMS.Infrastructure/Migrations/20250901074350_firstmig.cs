    ...
    public partial class firstmig : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseViewLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CourseViewLogs_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CourseViewLogs_Lessons_LessonId",
                        column: x => x.LessonId,
                        principalTable: "Lessons",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CourseViewLogs_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseViewLogs_CourseId",
                table: "CourseViewLogs",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_CourseViewLogs_LessonId",
                table: "CourseViewLogs",
                column: "LessonId");

            migrationBuilder.CreateIndex(
                name: "IX_CourseViewLogs_StudentId",
                table: "CourseViewLogs",
                column: "StudentId");
